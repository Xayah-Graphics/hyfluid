...
#undef NGP_CUDA_HOST_DEVICE
    ...
    void initialize_mlp_parameters(std::uint32_t density_param_offset, float* params_full_precision, std::uint16_t* params, std::uint16_t* param_gradients);
    ...
    void initialize_global_color_parameters(std::uint32_t global_color_param_offset, float* params_full_precision, std::uint16_t* params, std::uint16_t* param_gradients);
